...
- ❌ Do NOT use any external issue trackers, only github as requested later in this file.
...
**Contract**
    ...
    The agent NEVER runs `ludus` commands unless explicitly instructed by the user.
