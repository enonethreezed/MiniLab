# Provisioning Windows 11 (workstation) - PowerShell Transcription
...
# win11-baseline.ps1): those write to the Microsoft-Windows-PowerShell/
...
# file-monitoring input per SIEM (see win11-splunk-forwarder.ps1 /
# win11-wazuh-agent.ps1 / elk-provision.sh).
...
$LogFile = "$LogDir\win11-powershell-transcription.log"
...
log "=========================================================="
log "  Win11 PowerShell Transcription setup started"
...
log "=========================================================="
log "  Win11 PowerShell Transcription setup COMPLETED"
log "  Full log: logs/win11-powershell-transcription.log"
log "=========================================================="
