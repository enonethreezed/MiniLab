# Provisioning Windows Server 2022 - Elastic Agent enrollment (Fleet)
# SOC Blue Team Lab. Only runs when the siem VM is running ELK (default,
# ENABLE_SPLUNK not set). Requires winserver-baseline.ps1 to have run first.
...
$LogFile = "$LogDir\winserver-elastic-agent.log"
...
log "=========================================================="
log "  WinServer Elastic Agent enrollment started  |  ELK: $ELK_IP"
...
# Read ELK version to download matching Elastic Agent
...
log "=========================================================="
log "  WinServer Elastic Agent enrollment COMPLETED"
log "  Elastic Agent: enrolled with Fleet -> $FleetURL"
log "  Full log:      logs/winserver-elastic-agent.log"
log "=========================================================="
log "  To add Elastic Defend:"
log "  Fleet -> Agent Policies -> Windows Endpoints -> Add integration"
log "  -> Elastic Defend -> set mode: Monitor or Protect"
log "=========================================================="
