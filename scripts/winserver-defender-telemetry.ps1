# Provisioning Windows Server 2022 - Windows Defender Operational telemetry
...
$LogFile = "$LogDir\winserver-defender-telemetry.log"
...
log "=========================================================="
log "  WinServer Defender telemetry setup started"
...
# PowerShell/Operational bump in winserver-baseline.ps1.
...
# -- 3. Summary ----------------------------------------------------------------
log "=========================================================="
log "  WinServer Defender telemetry setup COMPLETED"
log "  Full log: logs/winserver-defender-telemetry.log"
log "=========================================================="
