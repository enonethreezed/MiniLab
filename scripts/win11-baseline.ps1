# Provisioning Windows 11 (workstation) - baseline (Sysmon + Defender/Firewall)
# SOC Blue Team Lab
...
$LogFile = "$LogDir\win11-baseline.log"
...
log "=========================================================="
log "  Win11 baseline provisioning started"
...
log "=========================================================="
log "  Win11 baseline provisioning COMPLETED"
log "  Sysmon:      Olaf Hartong config"
log "  PS logging:  Script Block + Module (4103/4104)"
log "  RDP host:    localhost:23389"
log "  Full log:    logs/win11-baseline.log"
log "=========================================================="
