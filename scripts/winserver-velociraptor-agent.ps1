# Provisioning Windows Server 2022 - Velociraptor client install
...
$LogFile = "$LogDir\winserver-velociraptor-agent.log"
...
log "=========================================================="
log "  WinServer Velociraptor client install started"
...
$msiArgs = @("/i", "`"$MsiFile`"", "/quiet", "/norestart", "/l*v", "$LogDir\winserver-velociraptor-msi.log")
$proc = Start-Process -FilePath "msiexec.exe" -ArgumentList $msiArgs -Wait -PassThru
if ($proc.ExitCode -ne 0) {
  err "msiexec exited with code $($proc.ExitCode) - see logs/winserver-velociraptor-msi.log"
  Stop-Transcript; exit 1
}
...
# -- 3. Summary ----------------------------------------------------------------
log "=========================================================="
log "  WinServer Velociraptor client install COMPLETED"
log "  Full log: logs/winserver-velociraptor-agent.log"
log "=========================================================="
