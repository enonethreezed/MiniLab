...
# logging events 4103/4104, enabled by win11-baseline.ps1) and
# Microsoft-Windows-Sysmon/Operational (installed by win11-baseline.ps1, but
# never actually reaching the SIEM without this) both need their own
