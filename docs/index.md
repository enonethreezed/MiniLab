...
| VM | Box | IP | RAM | Role |
|---|---|---|---|---|
| `siem` | debian/bookworm64 | 192.168.56.10 | 12 GB | SIEM — ELK 8.x + Fleet Server by default, or Splunk Enterprise (`ENABLE_SPLUNK=true`) / Wazuh (`ENABLE_WAZUH=true`) (+ optional Guacamole) |
...
| `kali` | kalilinux/rolling | 192.168.56.100 | 2 GB | Attacker box, `ENABLE_KALI=true` |
